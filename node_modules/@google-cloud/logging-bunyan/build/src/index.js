 ...
 */
exports.NODEJS_BUNYAN_DEFAULT_LIBRARY_VERSION = '4.2.2'; // {x-release-please-version}
/**
...
class LoggingBunyan extends stream_1.Writable {
    ...
    _writeCall(entries, callback) {
        ...
        const alreadyWritten = (0, instrumentation_1.setInstrumentationStatus)(true);
        if (!alreadyWritten) {
            let instrumentationEntry = (0, instrumentation_1.createDiagnosticEntry)('nodejs-bunyan', this.getNodejsLibraryVersion());
            ...
            instrumentationEntry = (this.redirectToStdout
                ? this.cloudLog
                : this.cloudLog).entry(instrumentationEntry.metadata, instrumentationEntry.data);
    ...
    getNodejsLibraryVersion() {
        return exports.NODEJS_BUNYAN_DEFAULT_LIBRARY_VERSION;
    }
}
