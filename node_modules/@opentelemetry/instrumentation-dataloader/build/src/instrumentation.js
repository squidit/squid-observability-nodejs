...
class DataloaderInstrumentation extends instrumentation_1.InstrumentationBase {
    ...
    init() {
        return [
            new instrumentation_1.InstrumentationNodeModuleDefinition(MODULE_NAME, ['^2.0.0'], (dataloader, moduleVersion) => {
        ...
        function PatchedDataloader(...args) {
            ...
            self._wrap(inst, '_batchLoadFn', original => {
                return function patchedBatchLoadFn(...args) {
                    ...
                    const span = self.tracer.startSpan(`${MODULE_NAME}.batch`, {
    ...
    _getPatchedLoad(original) {
        ...
        return function patchedLoad(...args) {
            ...
            const parent = api_1.context.active();
            const span = instrumentation.tracer.startSpan(`${MODULE_NAME}.load`, { kind: api_1.SpanKind.CLIENT }, parent);
            return api_1.context.with(api_1.trace.setSpan(parent, span), () => {
    ...
    _getPatchedLoadMany(original) {
        ...
        return function patchedLoadMany(...args) {
            ...
            const parent = api_1.context.active();
            const span = instrumentation.tracer.startSpan(`${MODULE_NAME}.loadMany`, { kind: api_1.SpanKind.CLIENT }, parent);
            return api_1.context.with(api_1.trace.setSpan(parent, span), () => {
