...
function startQuerySpan(client, tracer, instrumentationConfig, name) {
...
function handleInvalidQuery(tracer, instrumentationConfig, originalQuery, ...args) {
    let result;
    const span = startQuerySpan(this, tracer, instrumentationConfig, _1.PgInstrumentation.BASE_SPAN_NAME);
    try {
